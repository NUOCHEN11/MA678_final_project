...
```{r include=FALSE}
#fit6 = lmer(log_price~factor(transmission) + log_age+factor(fuelType)+log_mpg + engineSize +(1+engineSize+factor(transmission)+factor(fuelType)+log_mpg+ log_age|model)+(1+log_age+engineSize|transmission), data = log_audi)
#summary(fit6)
#plot(fit6, alpha= 0.55)
#tab_model(fit6)
```
...
[1] Aditya Desai, _100,000 UK Used Car Data set_, https://www.kaggle.com/datasets/adityadesai13/used-car-dataset-ford-and-mercedes?select=cclass.csv
